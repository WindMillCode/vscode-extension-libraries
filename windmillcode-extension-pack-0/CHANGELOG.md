...
v 5.2.3
* fixed a bug with  angular frontend: analyze.
* added misc: rename files, provide a path and a regex and a replacemenet string and all your files will be replaced accordingly

v 5.2.4
* fixed a bug with angular frontend: analyze.

V 5.2.5
* added 	"angular ViewChild": to typescript snippets

v 5.2.6
* python.json edited some snippets

v 5.2.7
* replaced filepath.Join with utils.JoinAndConverttoOSFormat

v 5.2.8
* updated firebase run emulators

v 5.2.9
* fixed an issue in python.json
