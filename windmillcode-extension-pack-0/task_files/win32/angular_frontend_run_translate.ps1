...
try {
  ...
  if ( $langCodes -eq "") {
    $myprompt =" Provide a list of lang codes to run `n translation script. `n Provide them in comma separated format according to the options below. `n Example: 'zh, es, hi, bn' `n It's best to do 4 at a time. `n Options: zh, es, hi, uk, ar, bn, ms, fr, de, sw, am"
